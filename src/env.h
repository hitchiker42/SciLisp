...
#define push_binding(data,env) Push_generic_signal(binding,env,data)
#define pop_binding(env) pop_generic_signal(binding,env)
#define push_frame(data,env) push_generic_signal(frame,env,data)
#define pop_frame(env) pop_generic_signal(frame,env)
#define push_call(data,env) push_generic_signal(call,env,data)
#define pop_call(env) pop_generic_signal(call,env)
#define push_data(data_val,env) push_generic_signal(data,env,data_val)
#define pop_data(env) pop_generic_signal(data,env)

#define try_push_binding(data,env) push_generic_no_signal(binding,env,data)
#define try_pop_binding(env) pop_generic_no_signal(binding,env)
#define try_push_frame(data,env) push_generic_no_signal(frame,env,data)
#define try_pop_frame(env) pop_generic_no_signal(frame,env)
#define try_push_call(data,env) push_generic_no_signal(call,env,data)
#define try_pop_call(env) pop_generic_no_signal(call,env)
#define try_push_data(data,env) push_generic_no_signal(data,env,data)
#define try_pop_data(env) pop_generic_no_signal(data,env)
