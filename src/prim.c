...
c_intern_unsafe(global_obarray,Sarrayp);
c_intern_unsafe(global_obarray,Sconsp);
c_intern_unsafe(global_obarray,Snumberp);
c_intern_unsafe(global_obarray,Sintegerp);
c_intern_unsafe(global_obarray,Sfunctionp);
c_intern_unsafe(global_obarray,Sstringp);
c_intern_unsafe(global_obarray,Sstreamp);
c_intern_unsafe(global_obarray,Ssequencep);
c_intern_unsafe(global_obarray,Srealp);
c_intern_unsafe(global_obarray,Sbignump);
c_intern_unsafe(global_obarray,Sbigintp);
c_intern_unsafe(global_obarray,Sbigfloatp);
c_intern_unsafe(global_obarray,Shashtablep);
c_intern_unsafe(global_obarray,Smacrop);
c_intern_unsafe(global_obarray,Sspecial_formp);
c_intern_unsafe(global_obarray,Seq);
c_intern_unsafe(global_obarray,Seql);
c_intern_unsafe(global_obarray,Sequal);
c_intern_unsafe(global_obarray,Sevenp);
c_intern_unsafe(global_obarray,Soddp);
c_intern_unsafe(global_obarray,Szerop);
c_intern_unsafe(global_obarray,Sne);
c_intern_unsafe(global_obarray,Smul);
c_intern_unsafe(global_obarray,Sadd);
c_intern_unsafe(global_obarray,Sinc);
c_intern_unsafe(global_obarray,Ssub);
c_intern_unsafe(global_obarray,Sdec);
c_intern_unsafe(global_obarray,Sdiv);
c_intern_unsafe(global_obarray,Slt);
c_intern_unsafe(global_obarray,Sle);
c_intern_unsafe(global_obarray,Seq);
c_intern_unsafe(global_obarray,Sgt);
c_intern_unsafe(global_obarray,Sge);
c_intern_unsafe(global_obarray,Sabs);
c_intern_unsafe(global_obarray,Scos);
c_intern_unsafe(global_obarray,Sexp);
c_intern_unsafe(global_obarray,Sexpt);
c_intern_unsafe(global_obarray,Slog);
c_intern_unsafe(global_obarray,Smod);
c_intern_unsafe(global_obarray,Spow);
c_intern_unsafe(global_obarray,Ssin);
c_intern_unsafe(global_obarray,Stan);
c_intern_unsafe(global_obarray,Sassoc);
c_intern_unsafe(global_obarray,Sassq);
c_intern_unsafe(global_obarray,Scons);
c_intern_unsafe(global_obarray,Scopy_tree);
c_intern_unsafe(global_obarray,Sdrop);
c_intern_unsafe(global_obarray,Slast);
c_intern_unsafe(global_obarray,Srand_list);
c_intern_unsafe(global_obarray,Srassoc);
c_intern_unsafe(global_obarray,Srassq);
c_intern_unsafe(global_obarray,Spush);
c_intern_unsafe(global_obarray,Sreduce);
c_intern_unsafe(global_obarray,Snreverse);
c_intern_unsafe(global_obarray,Sreverse);
c_intern_unsafe(global_obarray,Sset_car);
c_intern_unsafe(global_obarray,Sset_cdr);
c_intern_unsafe(global_obarray,Ssplit);
c_intern_unsafe(global_obarray,Stake);
}
