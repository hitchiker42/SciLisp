...
#include <langinfo.h>
#define INSIDE_PRIMS
MAKE_TYPE(Tint8,int8,4,0xf5a67dc57a8fe232 ,NIL,sexp_int8);
MAKE_TYPE(Tint16,int16,5,0xf9e84c8f42970271 ,NIL,sexp_int16);
MAKE_TYPE(Tint32,int32,5,0xf9e1c08f4291a8df ,NIL,sexp_int32);
MAKE_TYPE(Tint64,int64,5,0xf9d0c88f42834344 ,NIL,sexp_int64);
MAKE_TYPE(Tuint8,uint8,5,0x34fa7f24f14f37fb ,NIL,sexp_uint8);
MAKE_TYPE(Tuint16,uint16,6,0x54bf46c60981dbb2 ,NIL,sexp_uint16);
MAKE_TYPE(Tuint32,uint32,6,0x54c64ac60988012c ,NIL,sexp_uint32);
MAKE_TYPE(Tuint64,uint64,6,0x54d746c609966d93 ,NIL,sexp_uint64);
MAKE_TYPE(Terror,error,5,0x9f7452dd75d54d31 ,NIL,sexp_error);
MAKE_TYPE(Treal32,real32,6,0x5db280f342c8a248 ,NIL,sexp_real32);
MAKE_TYPE(Treal64,real64,6,0x5da874f342c0395f ,NIL,sexp_real64);
MAKE_TYPE(Tbigint,bigint,6,0x102f3138836b306a ,NIL,sexp_bigint);
MAKE_TYPE(Tbigfloat,bigfloat,8,0xf7de010e01156121 ,NIL,sexp_bigfloat);
MAKE_TYPE(Tchar,char,4,0xf2a393910b5b3ebd ,NIL,sexp_char);
MAKE_TYPE(Tstring,string,6,0x704be0d8faaffc58 ,NIL,sexp_string);
MAKE_TYPE(Tarray,array,5,0x4f9e14b634c6b026 ,NIL,sexp_array);
MAKE_TYPE(Tstream,stream,6,0x4f6a36d8e8907985 ,NIL,sexp_stream);
MAKE_TYPE(Tfun,fun,3,0xdc907418febced5e ,NIL,sexp_fun);
MAKE_TYPE(Tsymbol,symbol,6,0xe81b0096bc73f511 ,NIL,sexp_symbol);
MAKE_TYPE(Tmacro,macro,5,0x12c837a52b5d72b3 ,NIL,sexp_macro);
MAKE_TYPE(Ttype,type,4,0xa79439ef7bfa9c2d ,NIL,sexp_type);
MAKE_TYPE(Thashtable,hashtable,9,0xdc0a27c41e40e62b ,NIL,sexp_hashtable);
MAKE_TYPE(Tregex,regex,5,0xbc35a7f3228f2b18 ,NIL,sexp_regex);
MAKE_TYPE(Tnil,nil,3,0x2146ba19257dc6ac ,NIL,sexp_nil);
MAKE_TYPE(Tcons,cons,4,0x0bca0591195d8188 ,NIL,sexp_cons);
MAKE_TYPE(Tenv,env,3,0xc2f01118f05367d4 ,NIL,sexp_env);
MAKE_TYPE(Tobarray,obarray,7,0x44bf7978b8fde4e9 ,NIL,sexp_obarray);
MAKE_TYPE(Ttrue,true,4,0x5b5c98ef514dbfa5 ,NIL,sexp_true);
MAKE_TYPE(Tfalse,false,5,0xb5fae2c14238b978 ,NIL,sexp_false);
MAKE_TYPE(Tuninterned,uninterned,10,0x4c424d27afb1f41b ,NIL,sexp_uninterned);
MAKE_SELF_QUOTING_SYMBOL(Etype,"type",4,0xa79439ef7bfa9c2d ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Ebounds,"bounds",6,0x52f60c4caef0b768 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Efile,"file",4,0xaad01178f02a6a23 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eread,"read",4,0x4ce6531fbfddd605 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eargs,"args",4,0x894930843ebc9d7c ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Ekey,"key",3,0x3dc94a19365b10ec ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Efatal,"fatal",5,0x83eeb7c1b653d9b9 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eundefined,"undefined",9,0x22a0e850add468a3 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eunbound,"unbound",7,0xc585bfa8c28cb01a ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Emath,"math",4,0x1f4f66a2ce8fb60f ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eeof,"eof",3,0xc2f32318f055bc41 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eio,"io",2,0x08b73907b55c4d71 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eoverflow,"overflow",8,0xe5be01d8506421ab ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Erange,"range",5,0x526eb811b28d5cb2 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Econst,"const",5,0x65c9718e19e3df34 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Eprint,"print",5,0x2f0792248c7d6068 ,NIL);
MAKE_SELF_QUOTING_SYMBOL(Evisibility,"visibility",10,0x512b4b435e30c025 ,NIL);
MAKE_SYMBOL(lisp_stdin,"stdin",5,0x07ce0cad53eda57d ,stdin,NIL,0);
MAKE_SYMBOL(lisp_stdout,"stdout",6,0x42e6d785a74f8c66 ,stout,NIL,0);
MAKE_SYMBOL(lisp_stderr,"stderr",6,0x104ce5858b0a80b5 ,stderr,NIL,0);
...
c_intern_unsafe(global_obarray,Kelement-type);
...
c_intern_unsafe(global_obarray,Kimport-from);
c_intern_unsafe(global_obarray,Kinitial-contents);
c_intern_unsafe(global_obarray,Ktest);
c_intern_unsafe(global_obarray,Kinitial-element);
...
c_intern_unsafe(global_obarray,nil);
c_intern_unsafe(global_obarray,nil);
c_intern_unsafe(global_obarray,nil);
c_intern_unsafe(global_obarray,nil);
c_intern_unsafe(global_obarray,nil);
