...
PRIM_DEFSUBR("assoc",assoc,2,1,0,0,3,f3,"(key list &optional test-fn)",subr_compiled);
PRIM_DEFSUBR("assq",assq,2,0,0,0,2,f2,"key list",subr_compiled);
...
MAKE_SELF_QUOTING_SYMBOL(Kround,"round",5,0x311418469f09741b ,{0});
MAKE_SELF_QUOTING_SYMBOL(Kfloor,"floor",5,0xa03a74a942db43bd ,{0});
MAKE_SELF_QUOTING_SYMBOL(Kceil,"ceil",4,0xd9951890fd6d7e88 ,{0});
MAKE_SELF_QUOTING_SYMBOL(Ktrunc,"trunc",5,0x8c28a4a7272b50a5 ,{0});
/*Special Forms*/
...
c_intern_unsafe(global_obarray,Kround);
c_intern_unsafe(global_obarray,Kfloor);
c_intern_unsafe(global_obarray,Kceil);
c_intern_unsafe(global_obarray,Ktrunc);
