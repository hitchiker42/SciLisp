...
sexp lisp_numlt(sexp x,sexp y);
sexp lisp_numgt(sexp x,sexp y);
sexp lisp_numle(sexp x,sexp y);
sexp lisp_numge(sexp x,sexp y);
sexp lisp_numne(sexp x,sexp y);
sexp lisp_pow(sexp x,sexp y);
