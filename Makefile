...
pkgdatadir = $(datadir)/scilisp
pkgincludedir = $(includedir)/scilisp
pkglibdir = $(libdir)/scilisp
pkglibexecdir = $(libexecdir)/scilisp
...
bin_PROGRAMS = SciLisp$(EXEEXT)
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in $(top_srcdir)/build-aux/depcomp \
	$(top_srcdir)/build-aux/texinfo.tex build-aux/ar-lib \
...
libSciLisp_la_DEPENDENCIES = SFMT/libSFMT.la
am__objects_1 = array.lo bignum.lo ccall.lo cffi.lo cons.lo env.lo \
	emacs_regex.lo eval.lo format.lo hash.lo hash_fn.lo lex.yy.lo \
	lisp_macros.lo lisp_math.lo lisp_system.lo lisp_types.lo \
	parser.lo print.lo prim.lo regex.lo sequence.lo tree.lo \
	unicode.lo
am_libSciLisp_la_OBJECTS = $(am__objects_1)
libSciLisp_la_OBJECTS = $(am_libSciLisp_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
PROGRAMS = $(bin_PROGRAMS)
am__objects_2 = frontend.$(OBJEXT)
am__objects_3 = c_codegen.$(OBJEXT)
am__objects_4 =
am_SciLisp_OBJECTS = $(am__objects_2) $(am__objects_3) \
	$(am__objects_4)
SciLisp_OBJECTS = $(am_SciLisp_OBJECTS)
SciLisp_DEPENDENCIES = SFMT/libSFMT.la libSciLisp.la
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(libSciLisp_la_SOURCES) $(SciLisp_SOURCES)
DIST_SOURCES = $(libSciLisp_la_SOURCES) $(SciLisp_SOURCES)
...
INFO_DEPS = $(srcdir)/doc/SciLisp.info
TEXINFO_TEX = $(top_srcdir)/build-aux/texinfo.tex
am__TEXINFO_TEX_DIR = $(top_srcdir)/build-aux
DVIS = doc/SciLisp.dvi
PDFS = doc/SciLisp.pdf
PSS = doc/SciLisp.ps
HTMLS = doc/SciLisp.html
TEXINFOS = doc/SciLisp.texi
TEXI2DVI = texi2dvi
...
ACLOCAL = ${SHELL} /home/tucker/Repo/SciLisp/build-aux/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/tucker/Repo/SciLisp/build-aux/missing autoconf
...
LIBOBJS = 
LIBS = -lffi -lpthread -lmpfr -lm -lgmp -ldl -lcord -lgc  -lreadline
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/tucker/Repo/SciLisp/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
abs_srcdir = /home/tucker/Repo/SciLisp
...
install_sh = ${SHELL} /home/tucker/Repo/SciLisp/build-aux/install-sh
...
libSciLisp.la: $(libSciLisp_la_OBJECTS) $(libSciLisp_la_DEPENDENCIES) $(EXTRA_libSciLisp_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK) -rpath $(libdir) $(libSciLisp_la_OBJECTS) $(libSciLisp_la_LIBADD) $(LIBS)
...
SciLisp$(EXEEXT): $(SciLisp_OBJECTS) $(SciLisp_DEPENDENCIES) $(EXTRA_SciLisp_DEPENDENCIES) 
	@rm -f SciLisp$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(SciLisp_OBJECTS) $(SciLisp_LDADD) $(LIBS)
...
include ./$(DEPDIR)/bignum.Plo
include ./$(DEPDIR)/c_codegen.Po
include ./$(DEPDIR)/ccall.Plo
include ./$(DEPDIR)/cffi.Plo
include ./$(DEPDIR)/cons.Plo
include ./$(DEPDIR)/emacs_regex.Plo
include ./$(DEPDIR)/env.Plo
include ./$(DEPDIR)/eval.Plo
include ./$(DEPDIR)/format.Plo
include ./$(DEPDIR)/frontend.Po
include ./$(DEPDIR)/hash.Plo
include ./$(DEPDIR)/hash_fn.Plo
include ./$(DEPDIR)/lex.yy.Plo
include ./$(DEPDIR)/lisp_macros.Plo
include ./$(DEPDIR)/lisp_math.Plo
include ./$(DEPDIR)/lisp_system.Plo
include ./$(DEPDIR)/lisp_types.Plo
include ./$(DEPDIR)/parser.Plo
include ./$(DEPDIR)/prim.Plo
include ./$(DEPDIR)/print.Plo
include ./$(DEPDIR)/regex.Plo
include ./$(DEPDIR)/sequence.Plo
...
$(srcdir)/doc/SciLisp.info: doc/SciLisp.texi 
...
doc/SciLisp.dvi: doc/SciLisp.texi  doc/$(am__dirstamp)
	$(AM_V_TEXI2DVI)TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc' \
	$(TEXI2DVI) $(AM_V_texinfo) --build-dir=$(@:.dvi=.t2d) -o $@ $(AM_V_texidevnull) \
	`test -f 'doc/SciLisp.texi' || echo '$(srcdir)/'`doc/SciLisp.texi

doc/SciLisp.pdf: doc/SciLisp.texi  doc/$(am__dirstamp)
	$(AM_V_TEXI2PDF)TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc' \
	$(TEXI2PDF) $(AM_V_texinfo) --build-dir=$(@:.pdf=.t2p) -o $@ $(AM_V_texidevnull) \
	`test -f 'doc/SciLisp.texi' || echo '$(srcdir)/'`doc/SciLisp.texi

doc/SciLisp.html: doc/SciLisp.texi  doc/$(am__dirstamp)
	$(AM_V_MAKEINFO)rm -rf $(@:.html=.htp)
	$(AM_V_at)if $(MAKEINFOHTML) $(AM_MAKEINFOHTMLFLAGS) $(MAKEINFOFLAGS) -I doc -I $(srcdir)/doc \
	 -o $(@:.html=.htp) `test -f 'doc/SciLisp.texi' || echo '$(srcdir)/'`doc/SciLisp.texi; \
	then \
	  rm -rf $@ && mv $(@:.html=.htp) $@; \
	else \
...
mostlyclean-aminfo:
	-rm -rf doc/SciLisp.t2d doc/SciLisp.t2p

clean-aminfo:
	-test -z "doc/SciLisp.dvi doc/SciLisp.pdf doc/SciLisp.ps doc/SciLisp.html" \
	|| rm -rf doc/SciLisp.dvi doc/SciLisp.pdf doc/SciLisp.ps doc/SciLisp.html
...
all-am: Makefile $(INFO_DEPS) $(LTLIBRARIES) $(PROGRAMS) config.h
install-binPROGRAMS: install-libLTLIBRARIES

installdirs: installdirs-recursive
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(infodir)"; do \
