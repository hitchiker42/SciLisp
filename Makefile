...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/include/config.h.in \
...
OTOOL64 = 
PACKAGE = scilisp
PACKAGE_BUGREPORT = SciLisp@gmail.com
...
pdfdir = ${docdir}
prefix = /home/tucker/Repo/SciLisp
program_transform_name = s,x,x,
psdir = ${docdir}
sbindir = ${exec_prefix}/sbin
sharedstatedir = ${prefix}/com
srcdir = .
subdirs =  src/gc/bdwgc src/libffi
...
#use recursive make for programs, but just but documentation rules here
SUBDIRS = src
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	tags tags-am uninstall uninstall-am uninstall-dvi-am \
	uninstall-html-am uninstall-info-am uninstall-pdf-am \
	uninstall-ps-am

all:
	[ -h SciLisp ] && unlink SciLisp || true
	[ ! -e SciLisp ] && ln -s src/SciLisp SciLisp
