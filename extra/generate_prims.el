...
(define basic-prims-list
  '(("+" "lisp_add" 2) ("-" "lisp_sub" 2) ("*" "lisp_mul" 2) ("/" "lisp_div" 2)
    ...
    ("not-eq" "lisp_not_eq" 2)("not-equal" "lisp_not_equal" 2)
    ...
    ("pprint" "lisp_pprint" 1)("sxhash" "lisp_hash_sexp" 1)
...
(define SciLisp-prims (append
                       basic-SciLisp-prims
  '(
    ((:lname . "iota") (:cname ."lisp_iota") (:minargs . 1)
     (:maxargs . 5) (:optargs . 4) (:keyargs . 0) (:restarg . 0))
    ;array functions
    ...
    ((:lname . "array-reduce") (:cname . "array_reduce")(:minargs . 2)
     (:maxargs . 3) (:optargs . 1) (:keyargs . 0)(:restarg . 0))
    ((:lname . "make-tree")(:cname . "make_tree")(:minargs . 1)
     (:maxargs . 3) (:optargs . 1) (:keyargs . 0)(:restarg . 1))
    ...
    ((:lname . "typeName") (:cname ."lisp_typeName") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "type-of") (:cname . "typeOf") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "print") (:cname ."lisp_print") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "println") (:cname ."lisp_println") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "eval") (:cname ."lisp_eval") (:minargs . 1)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "fopen") (:cname . "lisp_open") (:minargs . 1)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "fclose") (:cname . "lisp_close") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "fputs") (:cname . "lisp_fputs") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "fprint") (:cname ."lisp_fprint") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "fprintln") (:cname ."lisp_fprintln") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "cat") (:cname . "lisp_cat") (:minargs . 1)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 1))
    ((:lname . "pwd") (:cname . "lisp_getcwd") (:minargs . 0)
     (:maxargs . 0) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "system") (:cname . "lisp_system") (:minargs . 1)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 1))
    ((:lname . "ccall") (:cname . "ccall") (:minargs . 5)
     (:maxargs . 6) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ;bit twiddling
    ((:lname . "logxor") (:cname ."lisp_xor") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "logand") (:cname ."lisp_logand") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "logor") (:cname ."lisp_logor") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "ash") (:cname ."ash") (:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ;math functions
    ((:lname . "round") (:cname ."lisp_round") (:minargs . 1)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "drand") (:cname ."lisp_randfloat") (:minargs . 0)
     (:maxargs . 1) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "lrand") (:cname ."lisp_randint") (:minargs . 0)
     (:maxargs . 1) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "bigint") (:cname . "lisp_bigint") (:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0))
    ((:lname . "bigfloat") (:cname . "lisp_bigfloat") (:minargs . 1)
     (:maxargs . 3) (:optargs . 2) (:keyargs . 0) (:restarg . 0))
    ((:lname . "apply") (:cname . "lisp_apply") (:minargs . 2)
     (:maxargs . 3) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ...
    ((:lname . "re-subexpr")(:cname . "lisp_get_re_backref")(:minargs . 2)
     (:maxargs . 2) (:optargs . 0) (:keyargs . 0)(:restarg . 0))
    ((:lname . "list")(:cname . "lisp_list")(:minargs . 0)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 1))
    ((:lname . "split")(:cname . "cons_split")(:minargs . 1)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0)(:restarg . 0))
    ((:lname . "time")(:cname . "lisp_time")(:minargs . 0)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0) (:restarg . 0))
    ((:lname . "make-c-ptr")(:cname . "make_c_ptr")(:minargs . 1)
     (:maxargs . 2) (:optargs . 1) (:keyargs . 0)(:restarg . 0))
    ((:lname . "c-ptr-val")(:cname . "lisp_dereference_c_ptr")(:minargs . 1)
     (:maxargs . 1) (:optargs . 0) (:keyargs . 0) (:restarg . 0)))
