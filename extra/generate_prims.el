...
(define basic-prims-list
  '(("!=" "lisp_numne" 2 :doc "(num1 num2)")
    ("*" "lisp_mul_driver" 1 :restarg 1 :doc "(num1 num2)")
    ("+" "lisp_add_driver" 1 :restarg 1 :doc "(num1 num2)")
    ("++" "lisp_inc" 1 :doc "(number)")
    ("-" "lisp_sub_driver" 1 :restarg 1 :doc "(num1 num2)")
    ("--" "lisp_dec" 1 :doc "(number)")
    ("/" "lisp_div_driver" 1 :restarg 1 :doc "(num1 num2)")
    ("<" "lisp_numlt" 2 :doc "(num1 num2)")
    ("<=" "lisp_numle" 2 :doc "(num1 num2)")
    ("=" "lisp_numeq" 2 :doc "(num1 num2)")
    (">" "lisp_numgt" 2 :doc "(num1 num2)")
    (">=" "lisp_numge" 2 :doc "(num1 num2)")
    ("abs" "lisp_abs" 1 :doc "(number)")
    ("add-num" "lisp_add_num" 2 :doc "(num1 num2)")
    ("addhash" "hashtable_add_entry" 3 :optargs 1)
    ("apply" "lisp_apply" 2 :optargs 1)
    ("aref" "aref" 2)
    ("array->list" "array_to_list" 1 :doc "(array)")
    ("array-map!" "array_nmap" 2 :doc "(array map-fn)")
    ("array-map" "array_map" 2 :doc "(array map-fn)")
    ("array-qsort" "array_qsort" 2 :optargs 1 :doc "(array cmp-fn &optional in-place)")
    ("array-reduce" "array_reduce" 2 :optargs 1)
    ("array-reverse!" "array_nreverse" 1)
    ("array-reverse" "array_reverse" 1)
    ("ash" "ash" 2)
    ("assert" "lisp_assert" 1 :doc "(expr)")
    ...
    ("cat" "lisp_cat" 0 :restarg 1 :doc "(&rest seqs)")
    ("ccall" "ccall" 5 :optargs 1)
    ("cons" "Cons" 2 :doc "(car cdr)")
    ("cos" "lisp_cos" 1 :doc "(number)")
    ("div-num" "lisp_div_num" 2)
    ("drand" "lisp_randfloat" 0 :optargs 1 :doc "(&optional scale)")
    ...
    ("drop" "cons_drop" 2 :doc "(list n)")
    ("eq" "lisp_eq" 2 :doc "(obj1 obj2)")
    ("eql" "lisp_eql" 2 :doc "(obj1 obj2)")
    ("equal" "lisp_equal" 2 :doc "(obj1 obj2)")
    ("eval" "lisp_eval" 1 :optargs 1 :doc "(expr &optional env)")
    ("even?" "lisp_evenp" 1 :doc "(number)")
    ("exp" "lisp_exp" 1 :doc "(number)")
    ("expt" "lisp_pow" 2 :doc "(num1 num2)")
    ("fclose" "lisp_close" 1 :doc "(stream)")
    ("fopen" "lisp_open" 1 :optargs 1 :doc "(file &optional mode)")
    ...
    ("iota" "lisp_iota" 1 :optargs 4 :doc "(start &optional stop step seq-type round)")
    ("last" "lisp_last" 1)
    ("le" "lisp_cmp_le" 2)
    ("length" "lisp_length" 1 :doc "(sequence)")
    ("list" "lisp_list" 0 :restarg 1 :doc "(&rest objects)")
    ("list->array" "array_from_list" 1 :doc "(list)")
    ("list-qsort" "cons_qsort" 2)
    ("load" "lisp_load" 1 :doc "(file)")
    ("log" "lisp_log" 1 :doc "(number)")
    ...
    ("mapcar" "mapcar" 2 :doc "(list map-fn)")
;    ("max" "lisp_max" 2)
...
;    ("min" "lisp_min" 2)
    ...
    ("set-car!" "set_car" 2 :doc "(cell new-val)")
    ("set-cdr!" "set_cdr" 2 :doc "(cell new-val)")
    ("sin" "lisp_sin" 1 :doc "(number)")
    ("sort" "lisp_sort" 2 :doc "(seq sort-fn)")
    ("split" "cons_split" 1 :optargs 1)
    ("sqrt" "lisp_sqrt" 1 :doc "(number)")
    ("sub-num" "lisp_sub_num" 2)
    ("sxhash" "lisp_hash_sexp" 1 :doc "(object)")
    ("system" "lisp_system" 1 :restarg 1)
    ("take" "cons_take" 2)
    ("tan" "lisp_tan" 1 :doc "(number)")
    ("time" "lisp_time" 0 :optargs 1 :restarg 1)
    ("type-of" "typeOf" 1 :doc "(object)")
    ("typeName" "lisp_typeName" 1 :doc "(object)")
    ("zero?" "lisp_zerop" 1)))
...
(defun make-docstring (prim)
  (format "%s: %s" (prim-val :lname) (prim-name :doc)))
