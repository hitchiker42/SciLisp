...
DEFUN("char->string",lisp_char_to_string,1,0,0,0,1);
...
DEFUN("drand-r",lisp_randfloat_r,1,1,0,0,2);
...
DEFUN("logandn",lisp_logandn,2,0,0,0,2);
DEFUN("logior",lisp_logior,2,0,0,0,2);
DEFUN("logxor",lisp_xor,2,0,0,0,2);
DEFUN("lognot",lisp_lognot,1,0,0,0,1);
DEFUN("lrand",lisp_randint,0,1,0,0,1);
DEFUN("lrand-r",lisp_randint_r,1,1,0,0,2);
...
DEFUN("seed-rand",lisp_init_rand,0,1,0,0,1);
DEFUN("seed-rand-r",lisp_init_rand_r,0,1,0,0,1);
...
DEFUN("string->char",lisp_string_to_char,1,0,0,0,1);
...
MAKE_SYMBOL("drand-r",lisp_randfloat_r,0xe1a93f3916d684fc );
...
MAKE_SYMBOL("lrand-r",lisp_randint_r,0xcc47f0ae29775d9b );
