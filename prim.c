...
DEFUN("!=",lisp_numne,2,0,0,0,2,"(num1 num2)");
DEFUN("*",lisp_mul_driver,1,0,0,1,2,"(num1 num2)");
DEFUN("+",lisp_add_driver,1,0,0,1,2,"(num1 num2)");
DEFUN("++",lisp_inc,1,0,0,0,1,"(number)");
DEFUN("-",lisp_sub_driver,1,0,0,1,2,"(num1 num2)");
DEFUN("--",lisp_dec,1,0,0,0,1,"(number)");
DEFUN("/",lisp_div_driver,1,0,0,1,2,"(num1 num2)");
DEFUN("<",lisp_numlt,2,0,0,0,2,"(num1 num2)");
DEFUN("<=",lisp_numle,2,0,0,0,2,"(num1 num2)");
DEFUN("=",lisp_numeq,2,0,0,0,2,"(num1 num2)");
DEFUN(">",lisp_numgt,2,0,0,0,2,"(num1 num2)");
DEFUN(">=",lisp_numge,2,0,0,0,2,"(num1 num2)");
DEFUN("abs",lisp_abs,1,0,0,0,1,"(number)");
DEFUN("add-num",lisp_add_num,2,0,0,0,2,"(num1 num2)");
DEFUN("addhash",hashtable_add_entry,3,1,0,0,4,"(hash-table key value &optional option)");
DEFUN("apply",lisp_apply,2,1,0,0,3,"(fun arglist &optional env)");
DEFUN("aref",aref,2,0,0,0,2,"(array index)");
DEFUN("array->list",array_to_list,1,0,0,0,1,"(array)");
DEFUN("array-map!",array_nmap,2,0,0,0,2,"(array map-fn)");
DEFUN("array-map",array_map,2,0,0,0,2,"(array map-fn)");
DEFUN("array-qsort",array_qsort,2,1,0,0,3,"(array predicate &optional in-place)");
DEFUN("array-reduce",array_reduce,2,1,0,0,3,"(array function &optional init)");
DEFUN("array-reverse!",array_nreverse,1,0,0,0,1,"(array)");
DEFUN("array-reverse",array_reverse,1,0,0,0,1,"(array)");
DEFUN("ash",ash,2,0,0,0,2,"(value count)");
DEFUN("assert",lisp_assert,1,0,0,0,1,"(expr)");
DEFUN("assert-eq",lisp_assert_eq,2,0,0,0,2,"(obj1 obj2)");
DEFUN("assert-equal",lisp_assert_equal,2,0,0,0,2,"(obj1 obj2)");
DEFUN("assert-not-eq",lisp_assert_not_eq,2,0,0,0,2,"(obj1 obj2)");
DEFUN("assert-not-equal",lisp_assert_not_equal,2,0,0,0,2,"(obj1 obj2)");
DEFUN("bigfloat",lisp_bigfloat,1,2,0,0,3,"(number-or-string &optional prec rnd)");
DEFUN("bigint",lisp_bigint,1,0,0,0,1,"(number)");
DEFUN("c-ptr-val",lisp_dereference_c_ptr,1,0,0,0,1,"(pointer)");
DEFUN("cat",lisp_cat,0,0,0,1,1,"(&rest seqs)");
DEFUN("ccall",ccall,5,1,0,0,6,"(function-name libname return-type argtypes args &optional thread)");
DEFUN("copy-cons",copy_cons,1,0,0,0,1,"(cell)");
DEFUN("ffi-ccall",ffi_ccall,5,1,0,0,6,"(function-name libname return-type argtypes args &optional thread)");
DEFUN("char->string",lisp_char_to_string,1,0,0,0,1,"(character)");
DEFUN("cons",Cons,2,0,0,0,2,"(car cdr)");
DEFUN("cos",lisp_cos,1,0,0,0,1,"(number)");
DEFUN("documentation",lisp_get_docstring,1,0,0,0,1,"(obj)");
DEFUN("div-num",lisp_div_num,2,0,0,0,2,"(num1 num2)");
DEFUN("driv-!=",lisp_ne_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("driv-<",lisp_lt_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("driv-<=",lisp_le_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("driv-=",lisp_eq_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("driv->",lisp_gt_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("driv->=",lisp_ge_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("drop",cons_drop,2,0,0,0,2,"(list n)");
DEFUN("eq",lisp_eq,2,0,0,0,2,"(obj1 obj2)");
DEFUN("eql",lisp_eql,2,0,0,0,2,"(obj1 obj2)");
DEFUN("equal",lisp_equal,2,0,0,0,2,"(obj1 obj2)");
DEFUN("eval",lisp_eval,1,1,0,0,2,"(expr &optional env)");
DEFUN("even?",lisp_evenp,1,0,0,0,1,"(number)");
DEFUN("exp",lisp_exp,1,0,0,0,1,"(number)");
DEFUN("expt",lisp_pow,2,0,0,0,2,"(num1 num2)");
DEFUN("exit",lisp_exit,0,1,0,0,1,"(&optional exit-code)");
DEFUN("fclose",lisp_close,1,0,0,0,1,"(stream)");
DEFUN("fopen",lisp_open,1,1,0,0,2,"(file &optional mode)");
DEFUN("format",lisp_format,1,0,0,1,2,"(format &rest objects)");
DEFUN("fprint",lisp_fprint,2,0,0,0,2,"(obj stream)");
DEFUN("fprintln",lisp_fprintln,2,0,0,0,2,"(obj stream)");
DEFUN("fputs",lisp_fputs,2,0,0,0,2,"(obj stream)");
DEFUN("ge",lisp_cmp_ge,2,0,0,0,2,"(num1 num2)");
DEFUN("gensym",lisp_gensym,0,0,0,0,0,"()");
DEFUN("get-type",getKeywordType,1,0,0,0,1,"(obj)");
DEFUN("gethash",hashtable_get_entry,2,0,0,0,2,"(hash-table key)");
DEFUN("gt",lisp_cmp_gt,2,0,0,0,2,"(num1 num2)");
DEFUN("hash-table-entries",hashtable_num_entries,1,0,0,0,1,"(hash-table)");
DEFUN("hash-table-growth-factor",hashtable_growth_threshold,1,0,0,0,1,"(hash-table)");
DEFUN("hash-table-growth-size",hashtable_growth_factor,1,0,0,0,1,"(hash-table)");
DEFUN("hash-table-size",hashtable_size,1,0,0,0,1,"()");
DEFUN("iota",lisp_iota,1,4,0,0,5,"(start &optional stop step seq-type round)");
DEFUN("identity",lisp_identity,1,0,0,0,1,"(form)");
DEFUN("last",lisp_last,1,0,0,0,1,"(list)");
DEFUN("le",lisp_cmp_le,2,0,0,0,2,"(num1 num2)");
DEFUN("length",lisp_length,1,0,0,0,1,"(sequence)");
DEFUN("list",lisp_list,0,0,0,1,1,"(&rest objects)");
DEFUN("list->array",array_from_list,1,0,0,0,1,"(list)");
DEFUN("list-qsort",cons_qsort,2,0,0,0,2,"(list predicate)");
DEFUN("load",lisp_load,1,0,0,0,1,"(file)");
DEFUN("log",lisp_log,1,0,0,0,1,"(number)");
DEFUN("logand",lisp_logand,2,0,0,0,2,"(int1 int2)");
DEFUN("logandn",lisp_logandn,2,0,0,0,2,"(int1 int2)");
DEFUN("logior",lisp_logior,2,0,0,0,2,"(int1 int2)");
DEFUN("logxor",lisp_xor,2,0,0,0,2,"(int1 int2)");
DEFUN("lognot",lisp_lognot,1,0,0,0,1,"(integer)");
DEFUN("lt",lisp_cmp_lt,2,0,0,0,2,"(num1 num2)");
...
DEFUN("mapcar",mapcar,2,0,0,0,2,"(list map-fn)");
DEFUN("max",lisp_max_driver,1,0,0,1,2,"(number &rest numbers)");
DEFUN("merge-sort",sequence_merge_sort,2,0,0,0,2,"(seq predicate)");
DEFUN("min",lisp_min_driver,1,0,0,1,2,"(number &rest numbers)");
...
DEFUN("nth",lisp_nth,2,0,0,0,2,"(list n)");
DEFUN("odd?",lisp_oddp,1,0,0,0,1,"(integer)");
DEFUN("pop!",pop_cons,1,0,0,0,1,"(place)");
DEFUN("pow",lisp_pow_driver,1,0,0,1,2,"()");
DEFUN("pprint",lisp_pprint,1,0,0,0,1,"(object)");
DEFUN("print",lisp_print,1,0,0,0,1,"(object)");
DEFUN("print-to-string",lisp_print_to_string,1,0,0,0,1,"(object)");
DEFUN("println",lisp_println,1,0,0,0,1,"(object)");
DEFUN("push!",push_cons,2,0,0,0,2,"(new-val place)");
DEFUN("pwd",lisp_getcwd,0,0,0,0,0,"()");
DEFUN("qsort",sequence_qsort,2,0,0,0,2,"(seq predicate)");
DEFUN("raise-error",lisp_error,1,0,0,0,1,"(error-string)");
DEFUN("rand-array",rand_array,1,1,0,0,2,"()");
DEFUN("rand-list",rand_list,1,1,0,0,2,"()");
DEFUN("seed-rand",lisp_init_rand,0,1,0,0,1,"(seed-val)");
DEFUN("seed-rand-r",lisp_init_rand_r,0,1,0,0,1,"(seed-val)");
DEFUN("rand-float",lisp_randfloat,0,2,0,0,2,"(&optional state scale)");
DEFUN("rand-int",lisp_randint,0,2,0,0,2,"(&optional state unsigned)");
...
DEFUN("set-car!",set_car,2,0,0,0,2,"(cell new-val)");
DEFUN("set-cdr!",set_cdr,2,0,0,0,2,"(cell new-val)");
DEFUN("arglist",lisp_get_signature,1,0,0,0,1,"(function)");
DEFUN("sin",lisp_sin,1,0,0,0,1,"(number)");
DEFUN("sort",lisp_sort,2,0,0,0,2,"(seq sort-fn)");
DEFUN("split",cons_split,1,1,0,0,2,"()");
DEFUN("sqrt",lisp_sqrt,1,0,0,0,1,"(number)");
DEFUN("sub-num",lisp_sub_num,2,0,0,0,2,"()");
DEFUN("string->char",lisp_string_to_char,1,0,0,0,1,"(string)");
DEFUN("sxhash",lisp_hash_sexp,1,0,0,0,1,"(object)");
DEFUN("system",lisp_system,1,0,0,1,2,"()");
DEFUN("take",cons_take,2,0,0,0,2,"(list n)");
DEFUN("tan",lisp_tan,1,0,0,0,1,"(number)");
...
DEFUN("bigfloat-div",lisp_bigfloat_div,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-pow",lisp_bigfloat_pow,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-gt",lisp_bigfloat_gt,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-eq",lisp_bigfloat_eq,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-lt",lisp_bigfloat_lt,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-ge",lisp_bigfloat_ge,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-le",lisp_bigfloat_le,2,0,0,0,2,"(bigfloat1 bigfloat2)");
DEFUN("bigfloat-ne",lisp_bigfloat_ne,2,0,0,0,2,"(bigfloat1 bigfloat2)");
...
DEFUN("cdr",cdr,1,0,0,0,1,"(cell)");
DEFUN("cddr",cddr,1,0,0,0,1,"(cell)");
DEFUN("cdddr",cdddr,1,0,0,0,1,"(cell)");
DEFUN("cddddr",cddddr,1,0,0,0,1,"(cell)");
DEFUN("cdddar",cdddar,1,0,0,0,1,"(cell)");
DEFUN("cddar",cddar,1,0,0,0,1,"(cell)");
DEFUN("cddadr",cddadr,1,0,0,0,1,"(cell)");
DEFUN("cddaar",cddaar,1,0,0,0,1,"(cell)");
DEFUN("cdar",cdar,1,0,0,0,1,"(cell)");
DEFUN("cdadr",cdadr,1,0,0,0,1,"(cell)");
DEFUN("cdaddr",cdaddr,1,0,0,0,1,"(cell)");
DEFUN("cdadar",cdadar,1,0,0,0,1,"(cell)");
DEFUN("cdaar",cdaar,1,0,0,0,1,"(cell)");
DEFUN("cdaadr",cdaadr,1,0,0,0,1,"(cell)");
DEFUN("cdaaar",cdaaar,1,0,0,0,1,"(cell)");
DEFUN("car",car,1,0,0,0,1,"(cell)");
DEFUN("cadr",cadr,1,0,0,0,1,"(cell)");
DEFUN("caddr",caddr,1,0,0,0,1,"(cell)");
DEFUN("cadddr",cadddr,1,0,0,0,1,"(cell)");
DEFUN("caddar",caddar,1,0,0,0,1,"(cell)");
DEFUN("cadar",cadar,1,0,0,0,1,"(cell)");
DEFUN("cadadr",cadadr,1,0,0,0,1,"(cell)");
DEFUN("cadaar",cadaar,1,0,0,0,1,"(cell)");
DEFUN("caar",caar,1,0,0,0,1,"(cell)");
DEFUN("caadr",caadr,1,0,0,0,1,"(cell)");
DEFUN("caaddr",caaddr,1,0,0,0,1,"(cell)");
DEFUN("caadar",caadar,1,0,0,0,1,"(cell)");
DEFUN("caaar",caaar,1,0,0,0,1,"(cell)");
DEFUN("caaadr",caaadr,1,0,0,0,1,"(cell)");
DEFUN("caaaar",caaaar,1,0,0,0,1,"(cell)");
...
MAKE_SYMBOL("documentation",lisp_get_docstring,0x9e3c2c86f5e5b26 );
...
MAKE_SYMBOL("exit",lisp_exit,0xd46cf8911f285e3e );
MAKE_SYMBOL("fclose",lisp_close,0x5fd43b5b8cc8b872 );
MAKE_SYMBOL("fopen",lisp_open,0x9ad6eac17558fa36 );
MAKE_SYMBOL("format",lisp_format,0xfe8e7da7004b68e5 );
...
MAKE_SYMBOL("identity",lisp_identity,0x421216f1f5f1274 );
...
MAKE_SYMBOL("logandn",lisp_logandn,0x627d4511fd04e469 );
MAKE_SYMBOL("logior",lisp_logior,0x7987426e87784556 );
MAKE_SYMBOL("logxor",lisp_xor,0xb1cc27255025b0d7 );
MAKE_SYMBOL("lognot",lisp_lognot,0x5d3adf6e76c8d6fd );
...
MAKE_SYMBOL("seed-rand",lisp_init_rand,0xc1336e3e260119aa );
MAKE_SYMBOL("seed-rand-r",lisp_init_rand_r,0x26b09ba9441b48a7 );
MAKE_SYMBOL("rand-float",lisp_randfloat,0xd7a3e2a6c9ca3a5d );
MAKE_SYMBOL("rand-int",lisp_randint,0xcffb580fd3c7c16 );
...
MAKE_SYMBOL("arglist",lisp_get_signature,0x927f550c1a5477ab );
...
MAKE_SYMBOL("string->char",lisp_string_to_char,0xcf515e822a90615e );
...
INIT_SYMBOL(lisp_get_docstring);
...
INIT_SYMBOL(lisp_exit);
INIT_SYMBOL(lisp_close);
INIT_SYMBOL(lisp_open);
INIT_SYMBOL(lisp_format);
...
INIT_SYMBOL(lisp_logandn);
INIT_SYMBOL(lisp_logior);
INIT_SYMBOL(lisp_xor);
INIT_SYMBOL(lisp_lognot);
...
INIT_SYMBOL(lisp_init_rand);
INIT_SYMBOL(lisp_init_rand_r);
